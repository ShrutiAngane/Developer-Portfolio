  ...
  return (
    <section className={`${theme?'bg-gray-900':''} flex flex-col items-center justify-evenly max-w-full lg:h-[1300px]`}>
      <div className='flex flex-col justify-evenly items-center mt-5'>
        <h2 className={`${theme?'text-[#FFFFFF]':'text-[#000000]'} text-[23px] font-medium font-bree`}>Skills</h2>
        <p className={`${theme?'text-[#FFFFFF]':'text-[#706C6C]'} text-[1.1rem] text-center font-normal mt-4 font-bree`}>Tech stack that I follow and have experience working with</p>
